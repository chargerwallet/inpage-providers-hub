...
function checkIfInjectedProviderConnected({ providerName, }) {
    ...
    if (providerName === cross_inpage_provider_types_1.IInjectedProviderNames.comlana) {
...
function checkIfInjectedProviderEnable({ providerName }) {
    ...
    const result = (0, cross_inpage_provider_core_1.checkWalletSwitchEnable)();
...
function createWalletConnectToButton({ container, onCreated, uri, }) {
