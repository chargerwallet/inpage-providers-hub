    ...
    replaceMethod() {
        ...
        const replaceFunc = ({ findName, icon, text, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (isSearchInput || isConnectButtonsContainer) {
                ...
                if (!(firstItem === null || firstItem === void 0 ? void 0 : firstItem.getAttribute('href'))) {
                    try {
                        ...
                        // noop
                        cross_inpage_provider_core_1.commonLogger.error(error);
                    }
                }
            ...
            if (svgQrcode) {
                ...
                // @ts-ignore
                const uri = yield (0, hackConnectButton_1.detectQrcodeFromSvg)({ img: svgQrcode });
                if (!uri || !uri.startsWith('wc:')) {
                    return;
                }
        ...
        void replaceFunc({
            ...
            text: consts_1.WALLET_CONNECT_INFO.chargerwallet.text,
        });
    },
});
