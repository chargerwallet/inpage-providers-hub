...
exports.styleContent = void 0;
exports.styleContent = `
.chargerwallet-inject-font {
	font-family: ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;
	font-style: normal;
	letter-spacing: -0.32px;
	color: rgba(0, 0, 0, 0.88);
}
.chargerwallet-inject-headingXl {
	/* headingXl */
	font-size: 20px;
	font-weight: 600;
...
.chargerwallet-inject-bodyLg {
	/* bodyLg */
	font-size: 16px;
	font-weight: 400;
	line-height: 24px; /* 150% */
}
.chargerwallet-inject-bodyLg-medium {
	/* bodyLg-medium */
	font-size: 16px;
	font-weight: 500;
	line-height: 24px; /* 150% */
...
.chargerwallet-inject-modal-container {
	display: flex;
	max-width: 384px;
	flex-direction: column;
...
.chargerwallet-inject-error-icon {
...
.chargerwallet-inject-error-icon > img {
  width: 24px;
  height: 24px;
}
.chargerwallet-inject-title {
	display: flex;
	align-items: center;
}
.chargerwallet-inject-risk-warning {
	margin-bottom: 20px;
}
.chargerwallet-inject-text-wrap {
	margin: 0;
	margin-top: 20px;
}
.chargerwallet-inject-text-subdued {
  margin-top: 8px;
  margin-bottom: 0px;
	color: rgba(0, 0, 0, 0.61);
}
.chargerwallet-inject-continue-link {
	text-decoration: underline;
	cursor: pointer;
}
.chargerwallet-inject-continue-link:hover {
	color: rgba(0, 0, 0, 0.7);
}
.chargerwallet-inject-continue-link:active {
	color: rgba(0, 0, 0, 0.5);
}
.chargerwallet-inject-footer {
	display: flex;
	padding:16px 20px;
	flex-direction: row;
...
.chargerwallet-inject-logo-content {
	width: 20px;
	height: 20px;
	margin-right: 6px;
...
@media (prefers-color-scheme: dark) {
	...
	.chargerwallet-inject-error-icon-content {
